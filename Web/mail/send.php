...
foreach ($id as $prodval) {
    ...
    if ($agent > 0) {
        ...
        if ($bagent_voucher != '') {
            $message .= "<span style='font-size:0.75em; font-weight: bold;'> Voucher No. (เอเย่นต์) :</span> " . $bagent_voucher . " <br />";
        }
    }
    $message .= "<span style='font-family:Roboto; font-size:0.75em;'>Voucher No. :</span> " . $bvoucher_no . " <br />";
