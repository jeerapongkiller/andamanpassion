...
?>
                        ...
                        <div class="d-flex align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="./?mode=agent/combine-product-list&ptype=<?php echo $ptype; ?>&supplier=<?php echo $sp_id; ?>&agent=<?php echo $agent; ?>&combine=<?php echo $combine; ?>">รายการสินค้า (<?php echo $ptype_name; ?>)</a></li>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="products_category_second" name="products_category_second" placeholder="" aria-describedby="inputSecond"
                                                    autocomplete="off" value="<?php echo htmlspecialchars($second_name); ?>" disabled>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_periods_from" name="third_periods_from" placeholder="" aria-describedby="inputFrom"
                                                    value="<?php echo $third_periods_from; ?>" disabled required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_periods_to" name="third_periods_to" placeholder="" aria-describedby="inputTo"
                                                    value="<?php echo $third_periods_to; ?>" disabled required>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_rate_1" name="third_rate_1" placeholder="" aria-describedby="inputRate1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_rate_1); ?>" oninput="priceformat('third_rate_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_rate_2" name="third_rate_2" placeholder="" aria-describedby="inputRate2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_rate_2); ?>" oninput="priceformat('third_rate_2');" required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_rate_3" name="third_rate_3" placeholder="" aria-describedby="inputRate3"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_rate_3); ?>" oninput="priceformat('third_rate_3');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_rate_4" name="third_rate_4" placeholder="" aria-describedby="inputRate4"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_rate_4); ?>" oninput="priceformat('third_rate_4');" required 
                                                    <?php if($ptype != 1 && $ptype != 2){ echo "readonly"; } ?>>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_charter_1" name="third_charter_1" placeholder="" aria-describedby="inputCharter1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_charter_1); ?>" oninput="priceformat('third_charter_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_charter_2" name="third_charter_2" placeholder="" aria-describedby="inputCharter2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_charter_2); ?>" oninput="priceformat('third_charter_2');" required 
                                                    <?php if($ptype != 1){ echo "readonly"; } ?>>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_group_1" name="third_group_1" placeholder="" aria-describedby="inputGroup1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_group_1); ?>" oninput="priceformat('third_group_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_group_2" name="third_group_2" placeholder="" aria-describedby="inputGroup2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_group_2); ?>" oninput="priceformat('third_group_2');" required 
                                                    <?php if($ptype != 2){ echo "readonly"; } ?>>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_pax" name="third_pax" placeholder="" aria-describedby="inputPax"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_pax); ?>" oninput="priceformat('third_pax');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_transfer_1" name="third_transfer_1" placeholder="" aria-describedby="inputTransfer1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_transfer_1); ?>" oninput="priceformat('third_transfer_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_transfer_2" name="third_transfer_2" placeholder="" aria-describedby="inputTransfer2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_transfer_2); ?>" oninput="priceformat('third_transfer_2');" required <?php if($ptype != 1 && $ptype != 2){ echo "readonly"; } ?>>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_hours_no" name="third_hours_no" placeholder="" aria-describedby="inputHours"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_hours_no); ?>" oninput="priceformat('third_hours_no');" disabled>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_extra_hour_1" name="third_extra_hour_1" placeholder="" aria-describedby="inputExtrahour1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_extra_hour_1); ?>" oninput="priceformat('third_extra_hour_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_extra_hour_2" name="third_extra_hour_2" placeholder="" aria-describedby="inputExtrahour2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_extra_hour_2); ?>" oninput="priceformat('third_extra_hour_2');" required <?php if($ptype != 3){ echo "readonly"; } ?>>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_extrabeds_1" name="third_extrabeds_1" placeholder="" aria-describedby="inputExtrabeds1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_extrabeds_1); ?>" oninput="priceformat('third_extrabeds_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_extrabeds_2" name="third_extrabeds_2" placeholder="" aria-describedby="inputExtrabeds2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_extrabeds_2); ?>" oninput="priceformat('third_extrabeds_2');" required <?php if($ptype != 4){ echo "readonly"; } ?>>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_sharingbed_1" name="third_sharingbed_1" placeholder="" aria-describedby="inputSharingbed1"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_sharingbed_1); ?>" oninput="priceformat('third_sharingbed_1');" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="third_sharingbed_2" name="third_sharingbed_2" placeholder="" aria-describedby="inputSharingbed2"
                                                    pattern="^[0-9,]+$" autocomplete="off" value="<?php echo number_format($third_sharingbed_2); ?>" oninput="priceformat('third_sharingbed_2');" required <?php if($ptype != 4){ echo "readonly"; } ?>>
        ...
        <script>
            function priceformat(inputfield){
				...
				while(i < j.length){ if(j[i] != ','){ num += j[i]; } i++; }
				var d = new Number(parseInt(num));
				var n = d.toLocaleString();
				if(n == 0){ document.getElementById(inputfield).value = ''; }else{ document.getElementById(inputfield).value = n; }
			}
        </script>