            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <button type="button" class="btn btn-info m-l-15" onclick="window.location.href='./?mode=supplier/detail'">
                ...
                <div class="row">
                    <script type="text/javascript">
                        ...
                        function deleteList(spid){
                            Swal.fire({
                                ...
                                if (result.value) {
                                    jQuery.ajax({
                                        url: "../inc/ajax/supplier/deletelist.php",
                                        data: {sp_id: spid},
                                        type: "POST",
                        ...
                        function restoreList(spid){
                            Swal.fire({
                                ...
                                if (result.value) {
                                    jQuery.ajax({
                                        url: "../inc/ajax/supplier/restorelist.php",
                                        data: {sp_id: spid},
                                        type: "POST",
                                        success:function(response){
                                            Swal.fire({
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" method="post" id="frmsearch" name="frmsearch" action="./?mode=<?php echo $_GET["mode"]; ?>" novalidate>
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href='./?mode=supplier/list'"><i class="ti-reload"></i>&nbsp;&nbsp;ล้างค่าใหม่</button>
                                </form>
                                <script>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ซัพพลายเออร์ </h4>
                                    ...
                                    <table id="supplier-table" class="table display table-bordered table-striped no-wrap">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><a href="./?mode=supplier/detail&id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a></td>
