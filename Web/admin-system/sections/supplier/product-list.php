        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <button type="button" class="btn btn-info m-l-15" onclick="window.location.href='./?mode=supplier/product-first-detail&ptype=<?php echo $ptype; ?>&supplier=<?php echo $supplier; ?>'">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            if ($_SESSION["admin"]["permission"] != 1) {
                                $query_second .= " AND trash_deleted != '1'";
                            }
                            if (!empty($row["id"])) {
                            ...
                            ?>
                                ...
                                <p><span class="card-title" style="font-size: 1.125rem"><?php echo $row_second["name"]; ?> &nbsp;&nbsp;
                                        ...
                                        <?php if ($row_second["withholding_tax"] == 1) {
                                            echo "( 1% Withholding Tax )";
                                        } ?></span> &nbsp;&nbsp;
                                ...
                                <div class="table-responsive">
                                    <table class="table color-bordered-table muted-bordered-table">
                                        <thead>
                                            <tr align="center">
                                                <th style="text-align:left">ระยะเวลา &nbsp;&nbsp;
                                                    <button type="button" class="btn btn-info" style="padding: 3px 8px" onclick="window.location.href='./?mode=supplier/product-third-detail&ptype=<?php echo $ptype; ?>&supplier=<?php echo $supplier; ?>&catefirst=<?php echo $row['id']; ?>&catesecond=<?php echo $row_second['id']; ?>'">
                                        ...
                                        <tbody style="font-weight:500">
                                            ...
                                            if ($_SESSION["admin"]["permission"] != 1) {
                                                $query_third .= " AND trash_deleted != '1'";
                                            }
